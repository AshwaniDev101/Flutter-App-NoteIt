...
class WebSocketConnectionIndicator extends StatefulWidget {
  ...
  @override
  State<WebSocketConnectionIndicator> createState() =>
      _WebSocketConnectionIndicatorState();
}

class _WebSocketConnectionIndicatorState
    extends State<WebSocketConnectionIndicator> {
