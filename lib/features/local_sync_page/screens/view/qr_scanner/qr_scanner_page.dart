...
import 'package:noteit/features/local_sync_page/screens/view/qr_scanner/widgets/shaded_overlay.dart';

import '../../../../../core/provider/sync_client_provider.dart';
    ...
    for (final barcode in barcodes) {
      ...
      if (rawValue != null && rawValue.startsWith('ws://')) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Connected to $hostName!')),
        );
