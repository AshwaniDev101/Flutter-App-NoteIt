        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: isSignedIn && user.photoURL != null ? NetworkImage(user.photoURL!) : null,
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _DrawerItem(icon: Icons.notes_rounded, title: 'All Notes', onTap: () => Navigator.pop(context)),
                _DrawerItem(
                ...
                const Padding(padding: EdgeInsets.symmetric(vertical: 8.0), child: Divider(indent: 16, endIndent: 16)),
                ...
                ListTile(
                  ...
                  title: Text('Dark Mode', style: textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w500)),
                  trailing: Switch(
                    value: isDarkMode,
                    onChanged: (value) {
