...
//                     : _buildSearchResults(driftDatabase, colorScheme, textTheme),
//               ),
//             ],
//           ),
//         ),
...
//   }
//
//   Widget _buildSearchResults(NoteDriftDatabase driftDatabase, ColorScheme colorScheme, TextTheme textTheme) {
//     return StreamBuilder<List<Note>>(
//       stream: driftDatabase.watchAllNotes(),
...
//           // Exclude notes marked for soft deletion.
//           if (note.isDeleted) return false;
//
//           final matchesTitle = note.title.toLowerCase().contains(query);
//
//           // Prevent exposing content of locked notes in search results.
